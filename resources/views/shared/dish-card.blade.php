<div class="col-md-3">
    <div class="card dish-card {{ in_array($dish->id, old('dishes', [])) ? 'selected' : '' }}"
        ...
        <div class="card-body">
            ...
            <p class="mb-1"><strong>Cena:</strong> {{ number_format($dish->price, 2) }} zł</p>
        ...
        <div class="card-footer">
            <div class="form-check">
                <input class="form-check-input dish-checkbox" type="checkbox" name="dishes[]"
                    ...
                    {{ in_array($dish->id, old('dishes', [])) ? 'checked' : '' }} style="pointer-events: none;">
