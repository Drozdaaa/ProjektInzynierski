...
<body>
    ...
    <div class="container-fluid mt-5 px-5">
        ...
        @if (!$restaurant)
            <h1 class="mb-4">Twoje menu</h1>

            <div class="alert alert-warning">
                <h5 class="alert-heading">Brak restauracji</h5>
                <p>
                    Najpierw utwórz swoją restaurację, aby móc zarządzać menu. <a
                        href="{{ route('restaurants.create') }}" >
                        <strong>Utwórz restaurację</strong>
                    </a>
                </p>
